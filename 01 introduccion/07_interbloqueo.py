...
# Función para el primer hilo que intenta adquirir los recursos en un orden
...
# Función para el segundo hilo que intenta adquirir los recursos en el orden inverso
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Simulación de un interbloqueo (deadlock) entre dos hilos.")
